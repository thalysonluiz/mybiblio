<x-app-layout>
    ...
    <div class="max-w-7xl px-2">
        ...
        <div class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
            <h2 class="text-2xl font-bold mb-7 dark:text-white">Importar Planilha de Livros</h2>

            <form method="post" action="{{ route('admin.importarExcel') }}" enctype="multipart/form-data">
                @csrf
                <div class="my-4">
                    <label @class([
                        'block',
                    ...
                    ]) aria-describedby="xlsx_arquive" id="xlsx_arquive"
                        name="arquivo_dados" type="file" value="{{ old('file') }}">
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-300" id="file_input_help">XLSX (Max.
                        20MB).</p>
                    @if ($errors->has('file'))
