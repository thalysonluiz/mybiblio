        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class=" flex justify-between gap-3">
                <div
                    ...
                    <div class="m-3">
                        <h2 class="text-2xl mb-4">Novo Capítulo</h2>
                        <form method="POST" action="{{ route('admin.summaries.store') }}">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <input type="hidden" name="book_id" value="{{ $book->id }}">
                            <input type="hidden" name="slug" value="{{ $book->slug }}">
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="number" name="n_capitulo"
                                    ...
                                    placeholder=" " id="n_capitulo" />
                                <label for="n_capitulo"
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <textarea name="objetivos" rows="5"
                                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-gray-600 dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                    placeholder=" " id="objetivos"></textarea>
                                <label for="objetivos"
                                    class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                                    Objetivos/Tópicos
                                </label>
...
<!-- xxx <div class="grid xl:grid-cols-2 xl:gap-6">
                <div class="relative z-0 w-full mb-6 group">
